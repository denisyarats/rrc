...
class TaskTwoEnv(gym.GoalEnv):
    ...
    def compute_reward(self, observation, info):
        ...
        above_ground = rewards.tolerance(object_pos[2],
                                         bounds=(0.8 * target_height, 1.2 * target_height),
        ...
        reward = (grasp +  above_ground_weight * above_ground + in_place_weight * in_place) / (1.0 + in_place_weight + above_ground_weight)
        return reward
